...
function App() {
  ...
  return (
    <Container
      ...
      minH="100vh"
    >
      <Button onClick={toggleColorMode} pos="absolute" top={0} right={0} m={3}>
      ...
      {txByHash?.result && txReceipt?.result ? (
        ...
        >
          <VStack align="flex-start">
            ...
            <StatGroup flexDir="column" gridGap="3">
              <Stat>
                ...
                <StatNumber>{`${txValue} ${ETH_SYMBOL}`}</StatNumber>
              </Stat>
              <Stat>
              ...
              <Fade in={Boolean(collectionData)}>
                <Stat>
                  ...
                  <StatNumber>
                    {isUnknownContract ? "--" : `${collectionRoyalty}%`}
                  </StatNumber>
                </Stat>
                <Stat>
          ...
          >
            <Box mb={4}>
              ...
              <Heading size="xl">{`${deriskAmount} ${ETH_SYMBOL}`}</Heading>
              <Text fontSize="sm">
                List for this amount to recoup purchase cost including fees
              </Text>
            </Box>
              ...
              <Box>
                ...
                <InputGroup size="sm">
                  <Input
                    ...
                    mb={1}
                  />
                  <InputRightAddon title="eth">{ETH_SYMBOL}</InputRightAddon>
                </InputGroup>
                <Text>your total profit would be</Text>
                <Heading size="md">{`${profit || 0} ${ETH_SYMBOL}`}</Heading>
              </Box>
            </Fade>
          </Flex>
        </Grid>
        ...
        <Flex justifyContent="center" py={5} textAlign="center">
          <Text fontSize="lg" maxW={400}>
            Enter a transaction hash/id above to view the transaction details
            and derisk amount.
          </Text>
        </Flex>
      )}
          ...
          <Box mt={5}>
            <Flex justifyContent="space-between" alignItems="center" mb={3}>
              ...
              >
                <Flex gridGap={3} alignItems="center">
                  ...
                  <Heading size="md">{collectionData?.name} Stats</Heading>
                </Flex>
              </Link>
              <Button
            ...
            <StatGroup gridGap={3}>
              <Stat>
                ...
                <StatNumber>{collectionStats?.stats.count}</StatNumber>
              </Stat>
              <Stat>
                <StatLabel>Floor</StatLabel>
                <StatNumber>
                  {`${Number(
                    collectionStats?.stats?.floor_price?.toFixed(4)
                  )} ${ETH_SYMBOL}`}
                </StatNumber>
              </Stat>
              <Stat>
      ...
      <Box as="footer" mt="auto" pt={10}>
        <Flex gridGap={5} justifyContent="center">
          <Box>
            <Link href="https://twitter.com/cody_0x" isExternal>
              @cody_0x
            </Link>
          </Box>
          <Box>
            <Link
              href="https://etherscan.io/address/0xd4281868e1868840f0911d99dd5e387a46de5d8d"
              isExternal
            >
              codyrose.eth
            </Link>
